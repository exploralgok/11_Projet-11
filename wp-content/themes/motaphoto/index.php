...
<div class="gallery">
                ...
                <select class="dropdown cat-list">
                    ...
                    <?php
                        foreach ( $categories as $category ) :
                            ?><option class="cat-list_item" value="<?php echo $category->slug ?>">
                ...
                <select class="dropdown format-list">
                    ...
                    <?php
                            foreach ( $formats as $format ) :
                                ?><option class="format-list_item" data-slugFormat="<?= $format->slug; ?>"
                        value="<?php echo $format->slug ?>"><?php echo $format->name ?></option><?php
                            endforeach;
                        ?>
                </select>
            </div>
    ...
    <div class="gallery__content">
        ...
        <button data-posts=8 class="btn__wrapper js-load-custom-posts">
